...
public final class ActivityInitializer {
	...
	public Activity initLeisureAtHomeWithFriendsActivity() {
		return ACTIVITY_BUILDER
				...
				.withAvailabilityIntervalAtDays(8,0,20,30, ISimulationSettings.WEEK)
				.withActivityLocation(ActivityLocation.HOME)
	...
	public Activity initPersonalCareAtHomeAloneActivity() {
		return ACTIVITY_BUILDER
				...
				.withNeedTimeSplit(NEED_TIME_SPLIT_BUILDER
						.withNeedTimeSplit(Need.SUBSISTENCE, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.PROTECTION, CalculationUtility.divide(CalculationUtility.FOUR, BigDecimal.TEN))
						.withNeedTimeSplit(Need.IDLENESS, CalculationUtility.divide(CalculationUtility.TWO, BigDecimal.TEN))
						.withNeedTimeSplit(Need.IDENTITY, CalculationUtility.divide(CalculationUtility.TWO, BigDecimal.TEN))
						.withNeedTimeSplit(Need.FREEDOM, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.build())
				.withExamples("Personal hygiene, dressing up, sports")
				.withAvailabilityIntervalAtDays(4,0,23,0, ISimulationSettings.WEEK)
				.withIsJointActivity(false)
				.withActivityLocation(ActivityLocation.HOME)
				.withNetworkType(NetworkType.NONE)
				.build();
	...
	public Activity initPersonalCareAtHomeWithHouseholdMembersActivity() {
		return ACTIVITY_BUILDER
				...
				.withNeedTimeSplit(NEED_TIME_SPLIT_BUILDER
						.withNeedTimeSplit(Need.SUBSISTENCE, CalculationUtility.divide(CalculationUtility.FIVE, CalculationUtility.ONE_HUNDRED))
						...
						.withNeedTimeSplit(Need.IDENTITY, CalculationUtility.divide(CalculationUtility.TWO, BigDecimal.TEN))
						.withNeedTimeSplit(Need.FREEDOM, CalculationUtility.divide(CalculationUtility.FIVE, CalculationUtility.ONE_HUNDRED))
						.build())
	...
	public Activity initPersonalCareAtThirdPlaceForPersonalCareWithFriendsActivity() {
		return ACTIVITY_BUILDER
				...
				.withNeedTimeSplit(NEED_TIME_SPLIT_BUILDER
						...
						.build())
				.withExamples("Sports")
				.withAvailabilityIntervalAtDays(8,0,19,0, ISimulationSettings.WEEK)
				.withActivityLocation(ActivityLocation.OTHER_PLACE_FOR_HOUSEHOLD_AND_FAMILY_CARE)
				.withNetworkType(NetworkType.FRIENDS_NETWORK)
				.build();
	}
	...
	public Activity initHouseholdAndFamilyCareAtHomeAloneActivity() {
		return ACTIVITY_BUILDER
				...
				.withNeedTimeSplit(NEED_TIME_SPLIT_BUILDER
						.withNeedTimeSplit(Need.SUBSISTENCE, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.PROTECTION, CalculationUtility.divide(CalculationUtility.TWO, BigDecimal.TEN))
						.withNeedTimeSplit(Need.AFFECTION, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.PARTICIPATION, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.IDLENESS, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.IDENTITY, CalculationUtility.divide(CalculationUtility.THREE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.FREEDOM, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.build())
				.withExamples("Housework, Shopping, family business, services and civic matters")
				.withAvailabilityIntervalAtDays(5,30,21,0, ISimulationSettings.WEEK)
				.withIsJointActivity(false)
				.withActivityLocation(ActivityLocation.HOME)
				.withNetworkType(NetworkType.NONE)
				.build();
	...
	public Activity initHouseholdAndFamilyCareAtHomeWithHousholdMembersActivty() {
		return ACTIVITY_BUILDER
				...
				.withNeedTimeSplit(NEED_TIME_SPLIT_BUILDER
						...
						.withNeedTimeSplit(Need.PROTECTION, CalculationUtility.divide(CalculationUtility.TWO, BigDecimal.TEN))
						.withNeedTimeSplit(Need.AFFECTION, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.PARTICIPATION, CalculationUtility.divide(CalculationUtility.THREE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.IDENTITY, CalculationUtility.divide(BigDecimal.ONE, BigDecimal.TEN))
						.withNeedTimeSplit(Need.FREEDOM, CalculationUtility.divide(CalculationUtility.TWO, BigDecimal.TEN))
						.build())
				.withExamples("Housework, Shopping, family business, services and civic matters")
				.withAvailabilityIntervalAtDays(6,0,20,0, ISimulationSettings.WEEK)
				.withActivityLocation(ActivityLocation.HOME)
				.withNetworkType(NetworkType.HOUSEHOLD_NETWORK)
				.build();
	}
	...
	public Activity initHouseholdAndFamilyCareAtThirdPlaceForHouseholdAndFamilyCareAloneActivity() {
		return ACTIVITY_BUILDER
				...
				.withAvailabilityIntervalAtDays(8,0,18,0, ISimulationSettings.WEEK)
				.withIsJointActivity(false)
				.withActivityLocation(ActivityLocation.OTHER_PLACE_FOR_HOUSEHOLD_AND_FAMILY_CARE)
				.withNetworkType(NetworkType.HOUSEHOLD_NETWORK)
				.build();
	...
	public Activity initSleepAtHomeActivity() {
		return ACTIVITY_BUILDER
				...
				.withNeedTimeSplit(NEED_TIME_SPLIT_BUILDER
						...
						.build())
				.withExamples("Sleep")
				.withAvailabilityIntervalAtDays(0,0,4,0, ISimulationSettings.WEEK)
				.withAvailabilityIntervalAtDays(21,0,23,59, ISimulationSettings.WEEK)
				.withIsJointActivity(false)
				.withActivityLocation(ActivityLocation.HOME)
				.withNetworkType(NetworkType.NONE)
				.build();
